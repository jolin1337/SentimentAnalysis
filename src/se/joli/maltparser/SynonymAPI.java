...
//            "Snäll"
//        };
        List<String> words = Files.readAllLines(Paths.get(args[0]), Charset.forName("utf-8"));
...
//            System.out.println();
        ...
        Files.write(Paths.get(args[1] + ".txt"), syns, Charset.forName("utf-8"));
        Files.write(Paths.get(args[1] + "neg.txt"), synsNeg, Charset.forName("utf-8"), StandardOpenOption.APPEND);
        System.out.println("Antal synonymer:" + synsCount);
    }
}
